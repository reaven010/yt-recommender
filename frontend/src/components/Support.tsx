...
import { Coffee, Github, Star, Heart } from "lucide-react";
...
function SupportCard({ icon, title, description, link, isInternal = false }: { icon: React.ReactNode, title: string, description: string, link: string, isInternal?: boolean }) {
  return (
    <motion.a
      href={link}
      ...
      whileHover={{ y: -5 }}
      className="p-8 rounded-[2rem] bg-white/[0.03] border border-white/5 hover:border-primary/20 transition-all flex flex-col gap-4 group/card"
    >
